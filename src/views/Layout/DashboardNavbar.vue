    ...
    <b-navbar-nav class="align-items-center ml-auto ml-md-0">
      ...
      >
          ...
          <b-media no-body class="align-items-center">
            <span class="avatar avatar-sm rounded-circle">
              <img
                ...
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlR3hMw_3daUL3Uhr5Y3uJh_kMaYzyqQhhPA&s"
              />
            </span>
            <b-media-body class="ml-2 d-none d-lg-block">
              <span class="mb-0 text-sm font-weight-bold" v-if="userdata">{{
        ...
        <template>
          ...
          <b-dropdown-item href="/dashboard/profile">
