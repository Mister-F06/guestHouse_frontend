          ...
          <b-row class="justify-content-center">
            <b-col xl="5" lg="6" md="8" class="px-5">
              ...
              <p class="text-lead text-white">
                Peu importe la raison de votre séjour, nous sommes déterminés à ce que
                vous vous sentiez chez vous, où que vous soyez.
              </p>
            </b-col>
          </b-row>
        </div>
          ...
          <div class="box" style="text-align: center">
            ...
            <p>
              ...
              <router-link to="/auth/login" class="text-light"
                ><span style="color: blue">ici</span></router-link
              >
        ...
        <div class="column is-6">
          <div class="box" style="text-align: center">
            ...
            <b-button
              ...
              variant="primary"
              @click="getNewLink()"
              :disabled="timeResend > 0 ? true : false"
              class="mt-4"
            >
              {{
                timeResend > 0
                  ? "Regénérer dans " + timeResend + " s"
                  : "Regénérer un nouveau lien de vérification"
              }}</b-button
            >
          </div>
        </div>
