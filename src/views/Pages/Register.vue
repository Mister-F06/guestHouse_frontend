            ...
            <b-card-header class="bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-4">
                ...
                <p class="text-lead text-white">
                  Rejoignez-nous et transformez l'accueil en art. Devenez gérant
                  aujourd'hui.
                </p>
              </div>
            </b-card-header>
              ...
              <validation-observer v-slot="{ handleSubmit }" ref="formValidator">
                <b-form role="form" @submit.prevent="handleSubmit(onCreateUser)">
                  ...
                  <div class="text-center">
                    <b-button type="submit" variant="primary" v-if="!load" class="mt-4"
                      >S'inscrire</b-button
                    >
                    <b-button variant="primary" v-else class="mt-4"
                      >Chargement..</b-button
                    >
                  </div>
                </b-form>
  ...
  methods: {
    async onCreateUser() {
      try {
        ...
        this.$toast.success("Veuillez vérifier votre e-mail pour activer votre compte.", {
          timeout: 6000,
        });
        this.load = false;
