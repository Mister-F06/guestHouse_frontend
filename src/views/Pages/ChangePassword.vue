    ...
    <b-container class="mt--8 pb-5">
      <b-row class="justify-content-center">
        <b-col lg="5" md="7">
            ...
            <b-card-header class="bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-3">
                ...
                <p class="text-lead text-white">
                  Découvrez un séjour inoubliable dans notre charmante guesthouse, nichée
                  au cœur du monde.
                </p>
              </div>
            </b-card-header>
            <b-card-body class="px-lg-5 py-lg-5">
              <div>
                <ul>
                  ...
                  <li>
                    Il doit inclure au moins un caractère spécial (par exemple: !, @, #,
                    $, etc.).
                  </li>
                </ul>
              </div>
          ...
          <b-row class="mt-3">
            <b-col cols="6">
              <router-link to="/auth/askEmailVerify" class="text-light"
